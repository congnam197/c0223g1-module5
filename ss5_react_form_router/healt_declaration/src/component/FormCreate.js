...
import * as yup from 'yup'
 export default function FormCreate(){
    const validationSchema= yup.object({
        ...
        dateOfBirth:yup.number().required("Năm sinh không được để trống").min(1990,"Năm sinh phải >1990"),
        ...
        email:yup.string().required("Email không được để trống").matches(/^[A-Z0-9a-z._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$/,"Email không đúng định dạng")
    });

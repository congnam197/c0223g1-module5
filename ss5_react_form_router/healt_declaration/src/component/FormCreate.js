...
export default function FormCreate() {
  ...
  const validationSchema = yup.object({
    ...
    numberOfHouses: yup.string().required("Không được để trống"),
      ...
      >
        <Form>
          ...
          <div>
            ...
            {SEX_LIST.map((gender) => (
              <div key={gender.index} className="gender">
                <label className="gender" htmlFor={gender.value}>
                {gender.label}
                </label>
                <Field type="radio" id={gender.value} name="gender" value={gender.value} />
              </div>
            ))}
          </div>
          <div>
          ...
          <div>
            <label className="manifestation" htmlFor="healthInsuranceCard">
              {" "}
          ...
          <div>
            ...
            <div>
              ...
              <label className="manifestation" htmlFor="fever">
                Sốt
              </label>
            </div>
            <div>
              <Field type="checkbox" id="cough" name="cough" value="cough" />
              <label className="manifestation" htmlFor="cough">
                Ho
              </label>
            </div>
            <div>
              <Field type="checkbox" id="sultry" name="sultry" value="sultry" />
              <label className="manifestation" htmlFor="sultry">
                Khó thở
              </label>
            </div>
            <div>
              <Field
                ...
                value="pneumonia"
              />
              <label className="manifestation" htmlFor="pneumonia">
                Viêm phổi
              </label>
            </div>
            <div>
              <Field
                ...
                value="soreThroat"
              />
              <label className="manifestation" htmlFor="soreThroat">
                Đau họng
              </label>
            </div>
            <div>
              <Field type="checkbox" id="tired" name="tired" value="tired" />
              <label className="manifestation" htmlFor="tired">
                Mệt mỏi
              </label>
            </div>
          </div>
